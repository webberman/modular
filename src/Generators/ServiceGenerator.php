...
class ServiceGenerator extends Generator
{
    ...
    public function createBroadcastServiceProvider($name, $path, $slug, $namespace)
    {
        ...
        $content = str_replace( ['{{name}}', '{{slug}}', '{{namespace}}'], [$name, $slug, $namespace], $content);
    ...
    public function createRouteServiceProvider($name, $path, $slug, $namespace)
    {
        ...
        $content = str_replace( ['{{name}}', '{{namespace}}', '{{controllers_namespace}}', '{{unit_namespace}}'], [$name, $namespace, $controllers, $foundation], $content);
    ...
    {
        $this->createFile($path.'/resources/views/welcome.blade.php', file_get_contents(__DIR__ . '/stubs/welcome.blade.stub') );
    }

...
class NewCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ->setName('new')
            ->setDescription('Create a new Webberman\Modular-architected project')
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln('<info>Crafting Webberman\Modular application...</info>');

        /*
         * @TODO: Get Webberman\Modular based on the Laravel version.
         */
